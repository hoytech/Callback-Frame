...
You should almost never need to, but the internal frame stack can be accessed at C<$Callback::Frame::top_of_stack>. Whenever this variable is defined, then a frame is being executed.
